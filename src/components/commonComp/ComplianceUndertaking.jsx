    ...
    <>
      ...
      <Container sx={{ py: 4 }}>
        ...
        >
          ...
          <Box sx={{ pl: 2, mb: 2 }}>
            <Typography variant="body1" paragraph>
              • Indiazona is an e-commerce Platform and in no way is or promotes
              a Pyramid Scheme, nor does it enroll any person who participates
              in such a scheme/arrangement in any manner whatsoever.
            </Typography>
            <Typography variant="body1" paragraph>
              • Indiazona doesn't charge any vendor/partner onboarding fees of
              any manner.
            </Typography>
            <Typography variant="body1" paragraph>
              • IndiaZona does not subject its buyers to any inflated product
              prices and that the prices of the products are solely decided by
              the Vendors who list their products on the Platform.
            </Typography>
            <Typography variant="body1" paragraph>
              • Likewise, Indiazona does not participate in any Money
              Circulation Scheme, nor does it enroll any person who participates
              in such a scheme/arrangement in any manner whatsoever.
            </Typography>
            <Typography variant="body1" paragraph>
              • Indiazona is compliant with the provisions of the Consumer
              Protection (Direct Selling) Rules, 2021 promulgated vide No.
              G.S.R. 889(E) by Department of Consumer Affairs.
            </Typography>
          </Box>
          ...
          <Typography variant="body2" sx={{ mt: 2 }}>
            <strong>Registered Office:</strong> Room No. 1B/3, 2nd Floor, 11
            Clive Row, Dalhousie Square, Kolkata, West Bengal
          </Typography>
