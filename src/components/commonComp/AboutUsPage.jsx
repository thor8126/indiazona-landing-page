        ...
        >
          ...
          >
            <Typography variant="body1" paragraph>
              <strong style={{ color: "#FF944E" }}>
                Bharat Ki Apni Dukaan
              </strong>{" "}
              — that's what IndiaZona stands for. Co-founded by Bawna Pagaria,
              her father, Mr Rajesh Pagaria, and her brother, Mr Harsh Pagaria,
              IndiaZona is more than just an e-commerce marketplace; it is the
              continuation of a vision.
            </Typography>

            <Typography variant="body1" paragraph>
              Over a decade ago, Mr. Rajesh Pagaria, a true entrepreneur,
              dreamed of creating opportunities and generating employment
              through innovative chain and network marketing. Though the idea
              was ahead of its time, today, his children are bringing that
              vision to life, adapting it to the needs of the modern world under
              his mentorship.
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              ...
              sellers, manufacturers, and small businesses often struggle to
              gain visibility despite their hard work.
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              We handle logistics, marketing, and global shipping, so sellers
              can focus on what they do best: creating unique products. Buyers,
              in turn, get access to authentic Indian creations, from
              handicrafts to fashion, all under one roof.
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              ...
              looking for authentic Indian products, we're here to bridge the
              gap and create opportunities for all.
            </Typography>
          </Box>
        </Paper>
      </Container>
