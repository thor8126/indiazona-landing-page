        ...
        >
          ...
          >
            <Typography variant="body1" paragraph>
              <strong style={{ color: "#FF944E" }}>At IndiaZona</strong> we
              honor the trust you have vested in us and we understand the
              importance of information privacy & its usage, secured
              transactions. In this privacy policy we have outlined as to how
              IndiaZona and{" "}
              <strong>
            ...
            <Typography variant="body1" paragraph>
              By using services offered by IndiaZona you agree to our use of
              your personal information (including sensitive personal
              information) in accordance with this Privacy policy. This policy
              may be amended from time to time by us at our discretion. You also
              agree and consent to us collecting, storing, processing,
              transferring, and sharing your personal information (including
              sensitive personal information) with third parties or service
              providers for the purposes set out in this Privacy Policy. This
              information is being stored on{" "}
              <strong>our servers in India</strong> and would be primarily used
              in
            ...
            <Typography variant="body1" paragraph>
              ...
              orders and your interests. We would uses cookies to track users’
              browsing activities on our site. These cookies help IndiaZona
              remember login details, shopping cart contents, and user
              preferences.Pixel Tags are small graphic files embedded in web
              pages and emails that track user interactions with the
              content.Browser Fingerprinting: This technique collects
              information about a user's device, browser type, language
              settings, and other configurations to create a unique identifier
              for tracking purposes.Clickstream Data: IndiaZona records data
              about the links and pages users click on, how long they stay on a
              page, and other navigation details. Secure Storage using
              encryption of Payment information, such as credit card details by
              s and <strong>our payment partners</strong>. IndiaZona complies
              with{" "}
              <strong>
              ...
              and app usage patterns.IndiaZona uses data from its own
              advertising network and third-party services to track and analyze
              user behavior for targeted advertising.
            </Typography>
            ...
            <Typography variant="body1" paragraph>
              We may share personal data internally within our group companies
              and related companies and third parties, including Credit Bureaus
              and business partners (such as payment platform), for purposes of
              providing products and services offered by them. These entities
              and affiliates may share such information with their affiliates,
              ...
              <strong>
                ...
                the Platform only upon confirmation that a valid prescription
                has been uploaded by you. In cases where the prescriptions
                uploaded by you are invalid, illegible, or expired or if
                prescription is not uploaded by you, we may, through third-party
                vendors connect You with medical practitioners, teleconsultants
                or third-party professionals where required to rectify the
                prescription or in case of invalid/illegible/expired
                prescription or issue a prescription in case prescription is not
                uploaded by you, based on the information that You provide to
                them. You agree and acknowledge that you will be redirected to
                the teleconsultation services only in limited cases where
                prescription validation or prescription issuance is required.
                (We are not going with medical products on our platform, should
                we include this in our privacy policy?)
              </strong>
              <br />
              <br />
            ...
            <Typography variant="body1" paragraph>
              ...
              necessary to prevent fraud or future abuse, to enable IndiaZona to
              exercise its legal rights and/or defend against legal claims or if
              required by law or we may continue to retain your data in
              anonymised form for analytical and research purposes. We maintain
              reasonable physical, electronic and procedural safeguards to
              protect your information. Whenever you access your account
            ...
            <Typography variant="body1" paragraph>
              Our Platform may contain links to third-party websites, products,
              or services that are not owned or controlled by IndiaZona. We
              provide these links for your convenience and reference only.
              IndiaZona has no control over, and assumes no responsibility for,
              the content, privacy policies, or practices of any third-party
              websites. By clicking on these links, you acknowledge and agree
              that IndiaZona is not responsible for the availability, accuracy,
              content, or any other aspect of third-party websites.
              Additionally, you acknowledge and agree that IndiaZona shall not
              be liable for any loss or damage incurred as a result of your
              interaction with these third-party websites provide links to other
              websites or applications that may collect personal data about you
              and you will be governed by their privacy policies. IndiaZona
              shall not be responsible for the privacy practices or the content
              of their privacy policies, and we request you to read their
